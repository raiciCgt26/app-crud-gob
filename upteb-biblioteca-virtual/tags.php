...
// Agarrar los tags
$query = "SELECT * FROM tags WHERE removed = 0 AND tag_category = 'PNF'";
$result = mysqli_query($con, $query);
?>
<main id="main" class="main">
<div class="container mt-5">
    <h1 class="text-center pagetitle">Lista de Programas Nacionales de Formación</h2>
<br>
