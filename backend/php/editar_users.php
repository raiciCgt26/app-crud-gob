...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $query = mysqli_query($con, "UPDATE usuarios SET username='$username', email='$email', role_id_fk='$role_id_fk', phone='$phone', description='$description' WHERE ID='$id'");
            ...
            <form method="POST">
              ...
              ?>
                ...
                <div class="user-details">
                  ...
                  <div class="input-box">
                    <span class="details">Role ID</span>
                    <input type="text" name="role_id_fk" value="<?php echo $row['role_id_fk'] ?>" placeholder="Enter role ID" required />
                  </div>
